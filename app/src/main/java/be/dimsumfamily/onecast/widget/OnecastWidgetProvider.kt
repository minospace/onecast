...
import be.dimsumfamily.onecast.playback.PlaybackService
import be.dimsumfamily.onecast.ui.MainActivity
...
class OnecastWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TOGGLE = "be.dimsumfamily.onecast.widget.ACTION_TOGGLE"
        const val ACTION_SKIP_FORWARD = "be.dimsumfamily.onecast.widget.ACTION_SKIP_FORWARD"
        const val ACTION_SKIP_BACK = "be.dimsumfamily.onecast.widget.ACTION_SKIP_BACK"
