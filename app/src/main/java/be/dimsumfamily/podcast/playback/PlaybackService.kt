...
import be.dimsumfamily.podcast.PodcastApp
import be.dimsumfamily.podcast.widget.WidgetState
...
class PlaybackService : MediaSessionService() {
    ...
    private val repository get() = (application as PodcastApp).repository
    ...
    override fun onCreate() {
        ...
        val httpDataSourceFactory = DefaultHttpDataSource.Factory()
            .setUserAgent("PodcastApp/1.0 (Android)")
